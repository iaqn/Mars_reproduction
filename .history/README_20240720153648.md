...
## Create Enviroment i use cuda11.8
first we need create a cuda virtual enviroment
conda create --name mars -y python=3.9
conda activate mars

Then, we need install tiny-cuda-nn


pip install mars-nerfstudio   (this need  torch >= 1.13.1 )
...
参考文章：https://blog.csdn.net/weixin_42896263/article/details/131978295
